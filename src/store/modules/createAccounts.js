...
const actions = {
  createProfessor({ commit }, formData) {
    axios
      .post('/api/createaccprof', formData)
      .then((response) => {
  ...
  createStudent({ commit }, formData) {
    axios
      .post('/api/createaccstud', formData)
      .then((response) => {
  ...
  createStaff({ commit }, formData) {
    axios
      .post('/api/createaccadm', formData)
      .then((response) => {
  ...
  updateAccountManager({ commit }, route, formData) {
    axios
      .put('/api/updateManager/' + route, formData)
      .then((response) => {
        // console.log('create professor accounts' , response.data);
      })
      .catch((errors) => {
