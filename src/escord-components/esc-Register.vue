            ...
            <md-card>
              <md-card-content>
                ...
                <form @submit.prevent="registerValidate" novalidate>
                  <div
                    class="__name md-layout md-gutter md-alignment-center-space-between"
                  >
                    <div class="md-layout-item md-size-40">
                      ...
                      >
                        ...
                        <md-input
                          :disabled="sending"
                          v-model="registerData.profFN"
                        ></md-input>

                        <span
                          class="md-error"
                          v-if="!$v.registerData.profFN.required"
                    ...
                    <div class="md-layout-item md-size-20">
                      <md-field class="has-esc-accent">
                        <label>MI</label>
                        <md-input v-model="registerData.profMI"></md-input>
                      </md-field>
                    </div>
                    ...
                    <div class="md-layout-item md-size-40">
                      ...
                      >
                        ...
                        <md-input
                          :disabled="sending"
                          v-model="registerData.profLN"
                        ></md-input>

                        <span
                          class="md-error"
                          v-if="!$v.registerData.profLN.required"
                  ...
                  >
                    ...
                    <md-input
                      :disabled="sending"
                      v-model="registerData.profRank"
                    ></md-input>

                    <span
                      class="md-error"
                      v-if="!$v.registerData.profRank.required"
                      >Rank/ position is required.</span
                    >
                  </md-field>
                  ...
                  >
                    ...
                    <md-input
                      :disabled="sending"
                      v-model="registerData.profEmail"
                    ></md-input>

                    <span
                      class="md-error"
                      v-if="!$v.registerData.profEmail.required"
                      >Email is required.</span
                    >

                    <span
                      class="md-error"
                      v-else-if="!$v.registerData.profEmail.email"
                      >Invalid email.</span
                    >
                  </md-field>
                  ...
                  >
                    ...
                    <span
                      class="md-error"
                      v-if="!$v.registerData.profPassword.required"
                      >Password is required.</span
                    >

                    <span
                      class="md-error"
                      v-else-if="!$v.registerData.profPassword.minLength"
                  ...
                  >
                    ...
                    <span
                      class="md-error"
                      v-if="!$v.registerData.profPasswordConfirm.required"
                    ...
                    <span
                      class="md-error"
                      v-else-if="
                        !$v.registerData.profPasswordConfirm.sameAsPassword
                      "
                  ...
                  <div
                    class="__register-btn text-center md-layout md-gutter md-alignment-center-center"
                  >
                    <p>Already have an account?</p>
                    <p class="__link">
                      <router-link
                        class="md-body-2 text-esc-accent"
                        to="/login"
                      >
                        Log in here!
                      </router-link>
...
export default {
  ...
  validations: {
    registerData: {
      ...
      profPassword: { required, minLength: minLength(8) },
      profPasswordConfirm: { required, sameAsPassword: sameAs('profPassword') },
    },
  },
