    ...
    <div class="__wrap md-layout md-gutter">
      ...
      >
        <md-card
          ...
          v-for="cardInfo in overviewCards"
          :key="cardInfo.category"
        >
          <md-card-content>
            <div class="md-layout md-gutter md-alignment-center-space-between">
              <div
                class="md-layout-item md-size-50 md-small-size-100 md-layout md-gutter md-alignment-center-center"
              >
                <h3 class="title">{{ cardInfo.category }}</h3>
              </div>

              <div
                class="md-layout-item md-size-50 md-small-size-100 md-layout"
              >
                <div
                  class="md-layout-item md-size-100 md-layout md-gutter md-alignment-center-center"
                >
                  <h3 class="__total" v-if="cardInfo.total == 0">
                    {{ totalStudents }}
                  </h3>
      ...
      >
        <md-card
          ...
          v-for="studentInfo in studentCards"
          :key="studentInfo.program"
        >
          <md-card-content>
            <div class="md-layout md-gutter md-alignment-center-space-between">
              <div
