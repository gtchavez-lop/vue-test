  ...
  <div class="">
    <div class="__tableDiv">
      <div class="md-layout md-gutter md-alignment-center-space-between">
        <div
          class="__addButtons md-layout-item md-size-100 md-layout md-gutter md-alignment-center-space-between"
        >
          <div
            class="md-layout-item md-size-50 md-layout md-gutter md-alignment-center-center"
          >
            <md-button
          ...
          <div class="md-layout-item md-size-100" v-else-if="addNewStaff">
            <add-staff />
            <hr class="hr" />
          </div>
        </div>
        ...
        >
          <pagination
            type="esc-accent"
            no-arrows
            :page-count="userList.last_page"
            :value="userList.current_page"
            :total="userList.total"
            @input="studentInEnrollment"
          >
          </pagination>
        </div>
      ...
      <md-table v-model="userList.data" class="__tableMain mx-auto">
        ...
        <md-table-row v-for="(user, index) in userList.data" :key="index">
...
export default {
  ...
  methods: {
    ...
    async studentInEnrollment(studpage = 1) {
      await axios
        .get('/api/enrolldb/?page=' + studpage + '&search=' + this.search)
        .then(({ data }) => {
          this.userList = data;
