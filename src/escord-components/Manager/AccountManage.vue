<template>
  <div>
    <div>
      <md-button class="md-simple md-esc-accent" @click="showstafftable"
        >Staff Account</md-button
      >
      <md-button class="md-simple md-esc-accent" @click="showproftable"
        >Prof Account</md-button
      >
      <md-button class="md-simple md-esc-accent" @click="showstudenttable"
        >Student Account</md-button
      >
    </div>
    ...
    <div v-if="defaultvalbutton === 'prof'">
      ...
      >
        <pagination
          type="esc-accent"
          no-arrows
          :page-count="professor.last_page"
          :value="professor.current_page"
      ...
      <div
        class="md-layout-item md-size-66 md-xsmall-size-100 md-layout md-gutter md-alignment-center-space-between"
      >
    ...
    <div v-else-if="defaultvalbutton === 'staff'">
      ...
      >
        <pagination
          type="esc-accent"
          no-arrows
          :page-count="staff.last_page"
          :value="staff.current_page"
          :total="staff.total"
          @input="staffmis"
        >
        </pagination>
      ...
      <md-table v-model="staff.data" md-sort="name" md-sort-order="asc">
        ...
        <md-table-row v-for="(_, index) in staff.data" :key="index">
          <md-table-cell class="text-center">
    ...
    <div v-else>
      ...
      >
        <pagination
          type="esc-accent"
          no-arrows
          :page-count="student.last_page"
          :value="student.current_page"
          :total="student.total"
          @input="studmis"
        >
        </pagination>
      ...
      <md-table v-model="student.data" md-sort="name" md-sort-order="asc">
        ...
        <md-table-row v-for="(_, index) in student.data" :key="index">
          <md-table-cell class="text-center">
 ...
 ...mapGetters({getprofessor: 'getprofessor'}), */
  ...
  methods: {
    ...
    async studmis(studpage = 1) {
      await axios
        .get(
          '/api/showuseraccount/?page=' + studpage + '&search=' + this.search
        )
        .then(({ data }) => {
          this.student = data;
    ...
    async staffmis(staffpage = 1) {
      await axios
        .get(
          '/api/showadminaccount/?page=' + staffpage + '&search=' + this.search
        )
        .then(({ data }) => {
          this.staff = data;
          //     this.currentpage = page
    ...
    async profmis(staffpage = 1) {
      await axios
        .get(
          '/api/showprofaccount/?page=' + staffpage + '&search=' + this.search
        )
        .then(({ data }) => {
          this.professor = data;
          //     this.currentpage = page
