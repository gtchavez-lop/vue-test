  ...
  <div class="">
    <div class="md-layout md-gutter md-alignment-center-center">
      ...
      <div class="__table md-layout-item md-size-100">
        <md-table v-model="studentList" md-sort="studLN" md-sort-order="asc">
          <md-table-row class="title">
            ...
            <md-table-head class="text-center"
              >Subject Description</md-table-head
            >
            <md-table-head class="text-center">Units</md-table-head>
            <md-table-head class="text-center">Final Grades</md-table-head>
            <md-table-head class="text-center"
              >Final Grade * Units</md-table-head
            >
          </md-table-row>

          <md-table-row v-for="(student, index) in studentList" :key="index">
