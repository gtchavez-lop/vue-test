  ...
  <div class="">
    ...
    >
      ...
      >
        <md-button
          @click="showSelector"
          class="md-simple md-esc-darkgrey md-dense"
        >
          <span v-if="selectorShown" class="md-body-2 title _close"
            >CLOSE SELECTOR</span
          >
          <span v-else class="md-body-2 title _open"
            >CLICK TO SELECT CLASS</span
          >
        </md-button>
      </div>
        ...
        >
          ...
          <md-table-cell>
            ...
            <router-link
              :to="{
                name: 'EscEval',
                params: { studnum: student.student_number },
              }"
              >VIEW</router-link
            >
          </md-table-cell>
      ...
      <modal v-if="classicModal" @close="classicModalHide">
        ...
        <template slot="body">
          ...
          >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <md-input v-model="modalInfo.studNum" readonly></md-input>
                  </md-field>
                    ...
                    >
                      ...
                      <div class="md-layout-item md-size-33">
                        ...
                        >
                          ...
                          <span
                            class="md-error"
                            v-if="!$v.modalInfo.studHighSchoolGradYr.required"
                            >Field is required.</span
                          >
                        </md-field>
                      </div>
            ...
            <md-snackbar md-position="left" :md-active.sync="studNotEditted">
