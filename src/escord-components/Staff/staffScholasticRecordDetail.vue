        ...
        <div class="container">
          ...
          >
            ...
            >
              ...
              <div
                class="__selector md-layout md-gutter md-alignment-center-space-between"
              >
                <!-- SELECT PROGRAM -->
                <md-autocomplete
                  md-dense
          ...
          <div class="__mid">
            ...
            <div
              class="__name md-layout-item md-size-100 md-layout md-gutter md-alignment-center-center"
            >
              <div
                class="md-layout-item md-size-45 md-xsmall-size-100 md-small-size-100 md-layout md-gutter md-alignment-center-center"
              >
                <div
                  class="md-layout-item md-size-45 md-layout md-gutter md-alignment-center-center"
                >
                  <md-button
              ...
              <div
                class="md-layout-item md-size-50 md-xsmall-size-100 md-small-size-100 md-layout md-gutter md-alignment-center-center"
              >
                <div
                  class="md-layout-item md-size-85 md-layout md-gutter md-alignment-center-center"
                >
                ...
                <div
                  class="md-layout-item md-size-15 md-layout md-gutter md-alignment-center-center"
                >
                  <md-button
                    class="md-just-icon md-round md-esc-accent md-raised"
                  >
          ...
          <div class="__bottom __table">
            <!-- pagination -->
            <div
              class="md-layout md-gutter md-alignment-center-center __paginate"
            >
              <pagination
                type="esc-accent"
                no-arrows
                :page-count="getscholperProg.last_page"
                :value="getscholperProg.current_page"
                :total="getscholperProg.total"
                @input="getStudentPerProg"
              />
            </div>
            ...
            <modal v-if="classicModal" @close="classicModalHide">
              ...
              <template slot="body">
                ...
                >
                    ...
                    md-layout md-gutter md-alignment-top-space-between"
                      ...
                      md-layout-item md-size-33"
                        ...
                        >
                          ...
                          <md-input
                            v-model="modalInfo.studNum"
                            readonly
                          ></md-input>
                        </md-field>

                        <div
                          class="md-layout-item md-size-66 md-layout md-gutter md-alignment-space-between"
                        >
                          <div class="md-layout-item md-size-66">
                            ...
                            >
                              <label>Program</label>
                              <md-input
                                v-model="modalInfo.studProgram"
                              ></md-input>

                              <span
                                class="md-error"
                                v-if="!$v.modalInfo.studProgram.required"
                          ...
                          <div class="md-layout-item md-size-33">
                            ...
                            >
                              <label>Section</label>
                              <md-input
                                v-model="modalInfo.studSection"
                              ></md-input>

                              <span
                                class="md-error"
                                v-if="!$v.modalInfo.studSection.required"
                      ...
                      >
                        <div class=" md-layout-item md-size-33">
                          ...
                          >
                            ...
                            <md-input
                              v-model="modalInfo.studFN"
                              :disabled="sending"
                            ></md-input>

                            <span
                              class="md-error"
                              v-if="!$v.modalInfo.studFN.required"
                        ...
                        <div class=" md-layout-item md-size-33">
                          ...
                          >
                            ...
                            <md-input
                              v-model="modalInfo.studLN"
                              :disabled="sending"
                            ></md-input>

                            <span
                              class="md-error"
                              v-if="!$v.modalInfo.studLN.required"
                        ...
                        >
                          <div class="md-layout-item md-size-50">
                            ...
                            >
                              ...
                              <!--read only remove--->
                              <md-input
                                v-model="modalInfo.studBirthday"
                                :disabled="sending"
                              ></md-input>

                              <span
                                class="md-error"
                                v-if="!$v.modalInfo.studBirthday.required"
                          ...
                          <div class="md-layout-item md-size-50">
                            ...
                            >
                              ...
                              <md-input
                                v-model="modalInfo.studContactNum"
                                :disabled="sending"
                              ></md-input>

                              <span
                                class="md-error"
                                v-if="!$v.modalInfo.studContactNum.required"
                        ...
                        >
                          <div class="md-layout-item md-size-100">
                            ...
                            >
                              <label>Address</label>
                              <md-input
                                v-model="modalInfo.studAddress"
                                :disabled="sending"
                              ></md-input>

                              <span
                                class="md-error"
                                v-if="!$v.modalInfo.studAddress.required"
                          ...
                          >
                            <div class="md-layout-item md-size-66">
                              ...
                              >
                                ...
                                <md-input
                                  v-model="modalInfo.studElemSchool"
                                  :disabled="sending"
                                ></md-input>

                                <span
                                  class="md-error"
                                  v-if="!$v.modalInfo.studElemSchool.required"
                                  >Elementary school is required.</span
                                >
                              </md-field>
                            </div>
                            ...
                            <div class="md-layout-item md-size-33">
                              ...
                              >
                                ...
                                <md-input
                                  type="number"
                                  v-model="modalInfo.studElemGradYr"
                                  :disabled="sending"
                                ></md-input>

                                <span
                                  class="md-error"
                                  v-if="!$v.modalInfo.studElemGradYr.required"
                          ...
                          >
                            <div class="md-layout-item  md-size-66">
                              ...
                              >
                                ...
                                <md-input
                                  v-model="modalInfo.studHighSchool"
                                  :disabled="sending"
                                ></md-input>

                                <span
                                  class="md-error"
                                  v-if="!$v.modalInfo.studHighSchool.required"
                                  >High school is required.</span
                                >
                              </md-field>
                            </div>
                            ...
                            <div class="md-layout-item md-size-33">
                              <md-field
                                class="has-esc-accent"
                                :class="
                                  getValidationClass('studHighSchoolGradYr')
                                "
                              >
                                <label>Graduation Year</label>
                                <md-input
                                  type="number"
                                  v-model="modalInfo.studHighSchoolGradYr"
                                  :disabled="sending"
                                ></md-input>
                                ...
                                <span
                                  class="md-error"
                                  v-if="
                                    !$v.modalInfo.studHighSchoolGradYr.required
                                  "
                                  >Field is required.</span
                                >
                              </md-field>
                  ...
                  <!-- modal footer -->
                  <div
                    class="md-layout md-gutter md-alignment-center-space-between __modal-buttons"
                  >
                    <div
                      class="md-layout-item md-layout md-alignment-center-center"
                    >
                      <md-button
                        class="md-esc-darkgrey md-raised md-dense md-round md-layout-item md-size-75"
                    ...
                    >
                      <md-button
                        class="md-esc-accent md-raised md-dense md-round md-layout-item md-size-75"
                        type="submit"
                        :disabled="sending"
                      >
                        UPDATE
                  ...
                  <md-snackbar md-position="left" :md-active.sync="studEditted">
                    Student info of: {{ edittedStudInfo }} is successfully
                    updated.
                  </md-snackbar>
...
export default {
  ...
  methods: {
    ...
    UpdateSRMS() {
      axios
        .put('/api/scholupdate/' + this.srms_id, this.modalInfo)
        .then((response) => {})
        .catch((errors) => {
          this.error = errors.response.data;
        });
    ...
    ArchieveSRMS() {
      axios
        .put('api/scholarch/' + this.srms_id, {
          status_archieve: '1',
        })
        .then((response) => {
