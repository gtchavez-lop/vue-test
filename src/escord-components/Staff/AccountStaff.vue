                ...
                >
                  ...
                  >
                    ...
                    <md-input
                      ...
                      id="std-password"
                      autocomplete="family-name"
                      v-model="staffAcc.stdPassword"
                      :disabled="sending"
                    />

                    <span
                      class="md-error"
                      v-if="!$v.staffAcc.stdPassword.required"
                      >Password is required.</span
                    >
                    <span
                      class="md-error"
                      v-else-if="!$v.staffAcc.stdPassword.minlength"
                  ...
                  >
                    ...
                    <md-input
                      ...
                      id="confirm-pass"
                      autocomplete="family-name"
                      v-model="staffAcc.stdConfirmPass"
                      :disabled="sending"
                    />

                    <span
                      class="md-error"
                      v-if="!$v.staffAcc.stdConfirmPass.required"
                      >Confirm password is required.</span
                    >
                    <span
                      class="md-error"
                      v-else-if="!$v.staffAcc.stdConfirmPass.sameAsPassword"
...
export default {
  ...
  methods: {
    ...
    UpdateStaff() {
      ...
      axios
        .put('/api/updateAdmin/' + this.getcurrentUser.id, {
