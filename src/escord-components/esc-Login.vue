                ...
                <form @submit.prevent="loginValidate" novalidate>
                  ...
                  <span v-if="showStudNumInput">
                    ...
                    >
                      ...
                      <md-input
                        :disabled="sending"
                        v-model="loginData.userStudNum"
                      ></md-input>

                      <span
                        class="md-error"
                        v-if="!$v.loginData.userStudNum.required"
                        >Student number is required.</span
                      >
                    </md-field>
                  </span>
                  ...
                  <span v-else>
                    ...
                    >
                      ...
                      <span
                        class="md-error"
                        v-if="!$v.loginData.userEmail.required"
                        >Email is required.</span
                      >

                      <span
                        class="md-error"
                        v-else-if="!$v.loginData.userEmail.email"
                        >Invalid email.</span
                      >
                    </md-field>
                  </span>
                  ...
                  >
                    ...
                    <span
                      class="md-error"
                      v-if="!$v.loginData.userPassword.required"
                      >Password is required.</span
                    >
                  </md-field>

                  <md-checkbox v-model="loginData.rememberPass">
