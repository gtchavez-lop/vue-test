        ...
        <div class="modal-container" v-click-outside="closeModal">
          ...
          <div class="modal-body text-center">
            ...
            >
              <!-- INPUTS -->
              <div
                class="md-layout-item md-layout md-gutter md-alignment-center-space-between"
              >
                ...
                <div
                  class="md-layout-item md-small-size-100 md-layout md-gutter"
                >
                  <md-field
                  ...
                  >
                    ...
                    <span
                      class="md-error"
                      v-if="!$v.studentAcc.stdName.required"
                ...
                >
                  ...
                  >
                    ...
                    <md-input
                      ...
                      id="std-password"
                      autocomplete="family-name"
                      v-model="studentAcc.stdPassword"
                      :disabled="sending"
                    />

                    <span
                      class="md-error"
                      v-if="!$v.studentAcc.stdPassword.required"
                      >Password is required.</span
                    >
                    <span
                      class="md-error"
                      v-else-if="!$v.studentAcc.stdPassword.minlength"
                  ...
                  >
                    ...
                    <md-input
                      ...
                      id="confirm-pass"
                      autocomplete="family-name"
                      v-model="studentAcc.stdConfirmPass"
                      :disabled="sending"
                    />

                    <span
                      class="md-error"
                      v-if="!$v.studentAcc.stdConfirmPass.required"
                      >Confirm password is required.</span
                    >
                    <span
                      class="md-error"
                      v-else-if="!$v.studentAcc.stdConfirmPass.sameAsPassword"
                ...
                <div class="md-layout-item md-size-100 md-layout md-gutter">
                  ...
                  >
                    ...
                    <span
                      class="md-error"
                      v-if="!$v.studentAcc.stdEmail.required"
                      >The email is required.</span
                    >
                    <span
                      class="md-error"
                      v-else-if="!$v.studentAcc.stdEmail.email"
                      >Invalid email.</span
                    >
                  </md-field>
                </div>
              ...
              >
                <md-button
                  type="submit"
                  class="__modal-buttons md-esc-accent md-round"
                  :disabled="sending"
                  >Update Account</md-button
                >
              </div>
...
export default {
    ...
    studentAcc: {
      ...
      stdConfirmPass: {
        ...
        sameAs: sameAs(function() {
          return this.studentAcc.stdPassword;
        }),
      },
    },
  },
  methods: {
    ...
    UpdateStudent() {
      ...
      axios
        .put('/api/updateStudent/' + this.getcurrentUser.id, {
