        ...
        <div class="container">
              ...
              <div class="profile">
                ...
                <div class="md-layout md-alignment-center-center">
                  <div class="md-layout-item md-size-100  name">
                    ...
                    <h5>
                      {{ getcurrentUser.student_number }} {{ studProg }} |
                      {{ studYr }}{{ studSec }}
                    </h5>
                  </div>
          ...
          <div class="profile-content">
            <div class="cards md-layout md-alignment-center">
              <div
                class="md-layout-item md-medium-size-50 md-small-size-75 md-xsmall-size-100"
              >
                <router-link :to="{ name: 'Scholastic RecordStudent' }">
                  <md-card class="md-with-hover">
                    <md-card-content>
                      ...
                      <p class="text-center">
                        Click to view your scholastic record form
                      </p>
                    </md-card-content>
                  </md-card>
                </router-link>
              ...
              >
                <router-link
                  :to="{ name: 'EscTableEval', params: { srms_id: srms_id } }"
                >
                  <md-card class="md-with-hover">
                    <md-card-content>
                      <p class="md-title title text-center">
                      ...
                      <p class="text-center">
                        Click to view and download your evaluation form
                      </p>
                    </md-card-content>
                  </md-card>
                </router-link>
