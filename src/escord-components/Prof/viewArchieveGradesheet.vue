        ...
        <div class="container">
          ...
          >
            ...
            >
              <h5 class="md-subheading">
                {{ getGS.course_year }}{{ getGS.course_section }} |
                {{ getGS.course_short }}
              </h5>
              ...
              <p class="md-caption">
                {{ getGS.semester }} SEMESTER, SY. {{ getGS.sem_startyear }}-{{
                  getGS.sem_endyear
                }}
              </p>
            </div>
              ...
              >
                ...
                >
                  ...
                  <md-tooltip md-direction="bottom"
                    >Unarchieve Gradesheet</md-tooltip
                  >
                </md-button>
              </div>
          ...
          <div v-else class="__gradesheet-table">
            ...
            >
              ...
              <md-table-row v-for="(_, index) in getrow" :key="index">
...
export default {
  ...
  components: {},
  mounted() {
    this.$store.dispatch('showgsinfo', {
      route: this.$route.params.archievegs,
    });
  ...
  methods: {
    ...
    unArchieveGS() {
      axios
        .put('/api/unarchieveGS/' + this.$route.params.archievegs)
        .then((response) => {
