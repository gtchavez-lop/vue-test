      ...
      <div class="section profile-content">
        <div class="container">
          ...
          <div class="buttons">
            <!-- open modal button -->
            <md-button
              class="md-esc-accent md-wd md-round"
            ...
            <md-button class="md-esc-accent md-wd md-round">
              <router-link :to="{ name: 'ProfessorArchieve Table' }"
                >Show Archieve..</router-link
              >
            </md-button>
              ...
              <template slot="body">
                ...
                >
                  ...
                  >
                    ...
                    <span class="md-error" v-if="!$v.formData.subjDesc.required"
                      >Subject description is required.</span
                    >
                  </md-autocomplete>

                  <!-- subj code and unit -->
                  <div
                    class="md-layout-item md-layout md-gutter md-alignment-center-space-between md-size-100"
                  >
                    <md-field
                    ...
                    >
                      ...
                      <span
                        class="md-error"
                        v-if="!$v.formData.subjCode.required"
                    ...
                    >
                      ...
                      <span
                        class="md-error"
                        v-if="!$v.formData.subjUnit.required"
                        >Subject unit is required.</span
                      >

                      <span
                        class="md-error"
                        v-else-if="!$v.formData.subjUnit.maxLength"
                        >Maximum is 2 numbers.</span
                      >
                    </md-field>
                  </div>
                  ...
                  <div
                    class="md-layout-item md-size-100 md-layout md-gutter md-alignment-center-space-between"
                  >
                    <md-field
                      class="has-esc-accent md-layout-item md-size-45"
                    ...
                    >
                      ...
                      <span
                        class="md-error"
                        v-if="!$v.formData.subjDay.required"
                        >Set subject day/s.</span
                      >
                    ...
                    >
                      ...
                      <span
                        class="md-error"
                        v-if="!$v.formData.subjTime.required"
                        >Set subject time/s.</span
                      >
                    </md-field>
                  </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        class="md-error"
                        v-if="!$v.formData.subjSem.required"
                        >Required.</span
                      >
                    </md-autocomplete>
                    ...
                    <md-field
                      ...
                      :class="getValidationClass('subjSY_start')"
                    >
                      <label>SY Start</label>
                      <md-input
                        v-model="formData.subjSY_start"
                        required
                        type="number"
                        :disabled="sending"
                      >
                      ...
                      <span
                        class="md-error"
                        v-if="!$v.formData.subjSY_start.required"
                        >Required.</span
                      >

                      <span
                        class="md-error"
                        v-else-if="!$v.formData.subjSY_start.minLength"
                        >Format is `XXXX`.</span
                      >

                      <span
                        class="md-error"
                        v-else-if="!$v.formData.subjSY_start.maxLength"
                        >Format is `XXXX`.</span
                      >
                    </md-field>
                    ...
                    <md-field
                      class="has-esc-accent md-layout-item md-size-25"
                      :class="getValidationClass('subjSY_end')"
                    >
                      <label>SY End</label>
                      <md-input
                        v-model="formData.subjSY_end"
                        required
                        type="number"
                        :disabled="sending"
                      >
                      ...
                      <span
                        class="md-error"
                        v-if="!$v.formData.subjSY_end.required"
                        >Required.</span
                      >

                      <span
                        class="md-error"
                        v-else-if="!$v.formData.subjSY_end.minLength"
                        >Format is `XXXX`.</span
                      >

                      <span
                        class="md-error"
                        v-else-if="!$v.formData.subjSY_end.maxLength"
                        >Format is `XXXX`.</span
                      >
                    </md-field>
                  </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        class="md-error"
                        v-if="!$v.formData.classProg.required"
                        >Required.</span
                      >
                    </md-autocomplete>
                    ...
                    >
                      ...
                      <span
                        class="md-error"
                        v-if="!$v.formData.classYr.required"
                        >Required.</span
                      >
                    </md-autocomplete>
                    ...
                    >
                      ...
                      <span
                        class="md-error"
                        v-if="!$v.formData.classSec.required"
                        >Required.</span
                      >
                    </md-autocomplete>
                  </div>
          ...
          <div v-if="loadingStatus">
            <md-progress-spinner
              class="__gradesheet-header md-layout md-gutter md-alignment-top-space-between md-warning"
          ...
          <div v-else class="profile-content">
            ...
            <div class="__gs-cards md-layout md-gutter md-alignment-top-center">
              ...
              >
                <md-card-content>
                  <p>ID: {{ gs.gradesheetid }}</p>

                  <p>Subject: {{ gs.subjectcode }} {{ gs.subjectdesc }}</p>
                  <p>
                    Class: {{ gs.course_year }}{{ gs.course_section }} |
                    {{ gs.course_short }}
                  </p>
                  <p class="md-caption">
                    {{ gs.semester }}, SY {{ gs.sem_startyear }}-{{
                      gs.sem_endyear
                    }}
                  </p>

                  <span
                    v-if="selectedGS_infoShow === gs.gradesheetid"
                    class="text-info"
                  >
                    You have selected the card for {{ gs.subjectdesc }} with
                    gradesheet ID of: {{ gs.gradesheetid }}.
                  </span>
                </md-card-content>
                ...
                <md-card-actions>
                  ...
                  <router-link
                    :to="{
                      ...
                      params: { gradeshid: gs.gradesheetid },
                    }"
                    >Edit Gradesheet..</router-link
                  >
                </md-card-actions>
              </md-card>
            </div>
...
export default {
  ...
  methods: {
    ...
    showGS_info(gsID) {
      this.selectedGS_infoShow === gsID
        ? (this.selectedGS_infoShow = null)
        : (this.selectedGS_infoShow = gsID);
    },
